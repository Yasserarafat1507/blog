...
<body class="font-sans antialiased">
    ...
    <div class="container mx-auto p-8">
        <form action="{{ route('blog.store')}}" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 gap-6">
            <!-- Input Gambar -->
            @csrf
            @method('post')
            <div>
            ...
            <div>
                ...
                <textarea id="discripstion" name="discripstion" class="block w-full mt-1"></textarea>
            </div>
